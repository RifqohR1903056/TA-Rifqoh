    ...
    <div class="col-md-12 col-sm-12 ">
        <div class="x_panel">
            ...
            <div class="x_content">
                <br />                
              <?php 
              echo form_open_multipart('shodaqoh/add'); ?>
            ...
            <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                <input type="text" name = "jenis_shodaqoh" required="required" placeholder="Jenis Shodaqoh" class="form-control ">
                </div>
            </div>
            <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                <input type="text" name = "jml_shodaqoh" required="required" placeholder="Jumlah" class="form-control ">
                </div>
            </div>
