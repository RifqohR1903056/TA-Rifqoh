    ...
    <div class="col-md-12 col-sm-12 ">
        <div class="x_panel">
            ...
            <div class="x_content">
                <br />                
              <?php 
              echo form_open_multipart('prestasi/add'); ?>

            <div class="item form-group">
                <label class="col-form-label col-md-3 col-sm-3 label-align">Nama Kajian <span class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 ">
                <input type="text" name = "nm_kajian" required="required" placeholder="Nama Kajian" class="form-control ">
                </div>
            </div>
            <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                <input type="text" name = "hari" required="required" placeholder="Hari" class="form-control ">
                </div>
            </div>
            <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                <input type="text" name = "nm_ustad" required="required" placeholder="Nama Ustad" class="form-control ">
                </div>
            </div>
            <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                <input type="text" name = "pembahasan" required="required" placeholder="Pembahasan" class="form-control ">
                </div>
            </div>
