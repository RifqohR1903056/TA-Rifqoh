    ...
    <div class="col-md-12 col-sm-12 ">
        <div class="x_panel">
            ...
            <div class="item form-group">
                ...
                <input type="text" value ="<?= $prestasi->nm_kajian?>" name = "nm_kajian" required="required" placeholder="Nama Kajian" class="form-control ">
                </div>
            </div>
            <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                <input type="text" value ="<?= $prestasi->hari?>" name = "hari" required="required" placeholder="Hari " class="form-control ">
                </div>
            </div>
            <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                <input type="text" value ="<?= $prestasi->nm_ustad?>" name = "nm_ustad" required="required" placeholder="Nama Ustad" class="form-control ">
                </div>
            </div>
            <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                <input type="text" value ="<?= $prestasi->pembahasan?>" name = "pembahasan" required="required" placeholder="Pembahasan" class="form-control ">
                </div>
            </div>
