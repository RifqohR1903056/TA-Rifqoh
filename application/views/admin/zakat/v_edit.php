    ...
    <div class="col-md-12 col-sm-12 ">
        <div class="x_panel">
            ...
            <div class="x_content">
                <br />                
              <?php 
              echo form_open_multipart('zakat/edit/'.$zakat->id_zakat); ?>
            ...
            <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                <input type="text" value ="<?= $zakat->jenis_zakat?>" name = "jenis_zakat" required="required" placeholder="Jenis Zakat" class="form-control ">
                </div>
            </div>
            <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                <input type="text" value ="<?= $zakat->nm_pemberi?>" name = "nm_pemberi" required="required" placeholder="Nama Pemberi" class="form-control ">
                </div>
            </div>
            <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                <input type="text" value ="<?= $zakat->alamat?>" name = "alamat" required="required" placeholder="Alamat" class="form-control ">
                </div>
            </div>
            <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                <input type="text" value ="<?= $zakat->jumlah?>" name = "jumlah" required="required" placeholder="Jumlah" class="form-control ">
                </div>
            </div>
