    ...
    <div class="col-md-12 col-sm-12 ">
        <div class="x_panel">
            ...
            <div class="x_content">
                <br />                
              <?php 
              echo form_open_multipart('mustahik/add'); ?>
            ...
            <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                <input type="text" name = "jenis_mustahik" required="required" placeholder="Jenis Mustahik" class="form-control ">
                </div>
            </div>
            <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                <input type="text" name = "nm_mustahik" required="required" placeholder="Nama Mustahik" class="form-control ">
                </div>
            </div>
            <div class="item form-group">
            ...
            <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                <input type="text" name = "total" required="required" placeholder="Total" class="form-control ">
                </div>
            </div>
