    ...
    <div class="col-md-12 col-sm-12 ">
        <div class="x_panel">
            ...
            <div class="x_content">
                <br />                
              <?php 
              echo form_open_multipart('majelis/edit/'.$majelis->id_majelis); ?>
            ...
            <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                <input type="text" value ="<?= $majelis->nm_penceramah?>" name = "nm_penceramah" required="required" placeholder="Nama Penceramah" class="form-control ">
                </div>
            </div>
            <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                <input type="text" value ="<?= $majelis->keterangan?>" name = "keterangan" required="required" placeholder="Keterangan" class="form-control ">
                </div>
            </div>
