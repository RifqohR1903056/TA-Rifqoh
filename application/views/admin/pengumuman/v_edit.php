    ...
    <div class="col-md-12 col-sm-12 ">
        <div class="x_panel">
            ...
            <div class="item form-group">
                ...
                <input type="text" value ="<?= $pengumuman->judul_pengumuman?>" name = "judul_pengumuman" required="required" placeholder="Judul Pengumuman" class="form-control ">
                </div>
            </div>
            <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                    <textarea name="isi_pengumuman" class="form-control" placeholder="Isi Pengumuman" cols="30" rows="10"><?= $pengumuman->isi_pengumuman?></textarea>
                </div>
            </div>
